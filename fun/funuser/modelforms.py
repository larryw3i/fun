...
class FunuserModelForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'avatar': forms.FileInput( attrs={ 'class': 'custom-file-input preview-image' , 'aria-describedby':"avatarInputGroupFileAddon" , 'accept':'image/*' , } ) , 
            'birth_date': forms.DateInput( attrs={ 'class': 'form-control' , 'type':'date' }  ) , 
            'address': forms.TextInput( attrs={ 'class': 'form-control' } ) , 
            'hometown': forms.TextInput( attrs={ 'class': 'form-control' } ) , 
            'college': forms.TextInput( attrs={ 'class': 'form-control' } ) , 
            'full_name': forms.TextInput( attrs={ 'class': 'form-control ', 'placeholder':_('Full name'), 'style':'text-align: center;' } ) , 
