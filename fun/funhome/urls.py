...
urlpatterns = [
    ...
    path(
        "homesticker_detail/<uuid:pk>",
        views.HomestickerDetailView.as_view(),
        name="homesticker_detail",
    ),
    path(
        "homesticker_list",
        views.HomestickerListView.as_view(),
        name="homesticker_list",
    ),
    path(
        "funhomesticker_detail/<uuid:pk>",
        views.FunhomestickerDetailView.as_view(),
        name="funhomesticker_detail",
    ),
    path(
        "funhomesticker_list",
        views.FunhomestickerListView.as_view(),
        name="funhomesticker_list",
    ),
    path(
        "appreciation_detail/<uuid:pk>",
        views.AppreciationDetailView.as_view(),
        name="appreciation_detail",
    ),
    path("data_privacy", views.data_privacy, name="data_privacy"),
    path(
        "legal_information", views.legal_information, name="legal_information"
    ),
